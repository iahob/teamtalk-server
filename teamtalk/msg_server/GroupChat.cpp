...
void CGroupChat::HandleClientGroupNormalRequest(CImPdu* pPdu, CMsgConn* pFromConn)
{
    ...
    SPDLOG_ERROR("HandleClientGroupNormalRequest, user_id={}. ", user_id);
...
void CGroupChat::HandleGroupNormalResponse(CImPdu* pPdu)
{
    ...
    SPDLOG_ERROR("HandleGroupNormalResponse, user_id={}, group_cnt={}. ", user_id, group_cnt);
...
void CGroupChat::HandleClientGroupInfoRequest(CImPdu *pPdu, CMsgConn* pFromConn)
{
    ...
    uint32_t user_id = pFromConn->GetUserId();
    uint32_t group_cnt = msg.group_version_list_size();
    SPDLOG_ERROR("HandleClientGroupInfoRequest, user_id={}, group_cnt={}. ", user_id, group_cnt);
...
void CGroupChat::HandleGroupInfoResponse(CImPdu* pPdu)
{
    ...
    SPDLOG_ERROR("HandleGroupInfoResponse, user_id={}, group_cnt={}. ", user_id, group_cnt);
    ...
    if (pduAttachData.GetPduLength() > 0 && group_cnt > 0)
    {
        ...
        SPDLOG_ERROR("GroupInfoRequest is send by server, group_id={} ", group_id);
        ...
        {
            SPDLOG_ERROR("user_id={} is not in group, group_id={}. ", user_id, group_id);
            return;
        }
...
void CGroupChat::HandleGroupMessage(CImPdu* pPdu)
{
    ...
    if (msg_id == 0) {
        SPDLOG_ERROR("HandleGroupMsg, write db failed, {}->{}. ", from_user_id, to_group_id);
        return;
    }
    uint8_t msg_type = msg.msg_type();
    CDbAttachData attach_data((uchar_t*)msg.attach_data().c_str(), msg.attach_data().length());

    SPDLOG_ERROR("HandleGroupMsg, {}->{}, msg id={}. ", from_user_id, to_group_id, msg_id);
...
void CGroupChat::HandleGroupMessageBroadcast(CImPdu *pPdu)
{
    ...
    string msg_data = msg.msg_data();
    uint32_t msg_id = msg.msg_id();
    SPDLOG_ERROR("HandleGroupMessageBroadcast, {}->{}, msg id={}. ", from_user_id, to_group_id, msg_id);
...
void CGroupChat::HandleClientGroupCreateRequest(CImPdu* pPdu, CMsgConn* pFromConn)
{
    ...
    if (group_type == IM::BaseDefine::GROUP_TYPE_NORMAL) {
        SPDLOG_ERROR("HandleClientGroupCreateRequest, create normal group failed, req_id={}, group_name={}. ", req_user_id, group_name.c_str());
        return;
    }
	string group_avatar = msg.group_avatar();
	uint32_t user_cnt = msg.member_id_list_size();
	SPDLOG_ERROR("HandleClientGroupCreateRequest, req_id={}, group_name={}, avatar_url={}, user_cnt={} ",
...
void CGroupChat::HandleGroupCreateResponse(CImPdu* pPdu)
{
	...
	SPDLOG_ERROR("HandleGroupCreateResponse, req_id={}, result={}, group_id={}, group_name={}, member_cnt={}. ", user_id, result, group_id, group_name.c_str(), user_cnt);
...
void CGroupChat::HandleClientGroupChangeMemberRequest(CImPdu* pPdu, CMsgConn* pFromConn)
{
	...
	uint32_t group_id = msg.group_id();
	uint32_t user_cnt = msg.member_id_list_size();
	SPDLOG_ERROR("HandleClientChangeMemberReq, change_type={}, req_id={}, group_id={}, user_cnt={} ",
...
void CGroupChat::HandleGroupChangeMemberResponse(CImPdu* pPdu)
{
	...
	SPDLOG_ERROR("HandleChangeMemberResp, change_type={}, req_id={}, group_id={}, result={}, chg_usr_cnt={}, cur_user_cnt={}. ",
...
void CGroupChat::HandleGroupChangeMemberBroadcast(CImPdu* pPdu)
{
	...
	uint32_t chg_user_cnt = msg.chg_user_id_list_size();
    uint32_t cur_user_cnt = msg.cur_user_id_list_size();
	SPDLOG_ERROR("HandleChangeMemberBroadcast, change_type={}, group_id={}, chg_user_cnt={}, cur_user_cnt={}. ", change_type, group_id, chg_user_cnt, cur_user_cnt);
...
void CGroupChat::HandleClientGroupShieldGroupRequest(CImPdu *pPdu, CMsgConn *pFromConn)
{
    ...
    uint32_t group_id = msg.group_id();
    uint32_t user_id = pFromConn->GetUserId();
    SPDLOG_ERROR("HandleClientGroupShieldGroupRequest, user_id: {}, group_id: {}, shield_status: {}. ",
...
void CGroupChat::HandleGroupShieldGroupResponse(CImPdu *pPdu)
{
    ...
    uint32_t user_id = msg.user_id();
    uint32_t group_id = msg.group_id();
    SPDLOG_ERROR("HandleGroupShieldGroupResponse, result: {}, user_id: {}, group_id: {}. ", result,
        user_id, group_id);
...
void CGroupChat::HandleGroupGetShieldByGroupResponse(CImPdu *pPdu)
{
    ...
    SPDLOG_ERROR("HandleGroupGetShieldByGroupResponse, shield_status_list_cnt: {}. ",
    ...
    for (uint32_t i = 0; i < shield_status_list_cnt; i++)
    {
        ...
        {
            SPDLOG_ERROR("user_id: {} shield group, group id: {}. ", shield_status.user_id(), shield_status.group_id());
        }
    }
    CImPdu pdu;
    pdu.SetPBMsg(&msg2);
