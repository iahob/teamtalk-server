...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_IM_2eOther_2eproto;
namespace IM {
namespace Other {
class IMHeartBeat;
...
class IMHeartBeat final :
    public ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:IM.Other.IMHeartBeat) */ {
 public:
  ...
  inline void CopyFrom(const IMHeartBeat& from) {
